        ...
        <nav className="navbar">
            ...
            <div className="content">
                ...
                <ul className="menuList">
                    ...
                    <li><a href="/" className="scrollTo navLink"> Home </a></li>
                    <li><a href="/" className="scrollTo navLink"> Sobre </a></li>
                    <li><a href="/" className="scrollTo navLink"> Projetos </a></li>
                    <li><a href="/" className="scrollTo navLink"> Contato </a></li>
